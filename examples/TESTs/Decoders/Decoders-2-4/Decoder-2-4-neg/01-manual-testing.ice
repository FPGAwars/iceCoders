{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "d5ab75f6-bb2f-4983-9a80-ef60858148d1",
          "type": "basic.output",
          "data": {
            "name": "LED1",
            "pins": [
        ...
        {
          "id": "4d8c4e4e-f174-4dcd-84bd-1e7702a0c07d",
          "type": "basic.output",
          "data": {
            "name": "LED0",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Decoder 2-4-neg: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 120,
        ...
        {
          "id": "6e0f9696-13ce-4862-bff4-a1ee93cba594",
          "type": "ec7a37bf05cf67a62cd1e3711515408a84a59be9",
          "position": {
            "x": 288,
            "y": 288
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "6e0f9696-13ce-4862-bff4-a1ee93cba594",
        ...
        },
        {
          ...
          "target": {
            "block": "4d8c4e4e-f174-4dcd-84bd-1e7702a0c07d",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "d5ab75f6-bb2f-4983-9a80-ef60858148d1",
            "port": "in"
          }
        },
        {
  ...
  "dependencies": {
    "ec7a37bf05cf67a62cd1e3711515408a84a59be9": {
      "package": {
